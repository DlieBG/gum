        ...
        <div class="version">
            ...
            <div>
                <span class="timestamp">
                    ...
                    <input type=checkbox disabled={fileVersion.deleted || ['png', 'jpg', 'gif', 'pdf'].includes(data.fileVersion.fileName.split('.').at(-1))} bind:group={$diffIds} value={fileVersion.id}>
                </span>
